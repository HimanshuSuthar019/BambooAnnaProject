...
export default function Admin() {
  ...
  function loadData() {
    const allOrders = JSON.parse(localStorage.getItem("bamboo-orders") || "[]");
    const allUsers = JSON.parse(localStorage.getItem("bamboo-users") || "[]");
    const savedProducts = JSON.parse(localStorage.getItem("bamboo-products") || "[]");
    setOrders(allOrders.reverse());
    setUsers(allUsers.filter((u) => u.role !== "admin"));
    setProducts(savedProducts.length > 0 ? savedProducts : PRODUCTS);
  }
